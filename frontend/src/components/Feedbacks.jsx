...
const Feedbacks = () => {
  const { feedback, setFeedback, header, setHeader, sem, setSem  } = useFeedback();
  ...
  return (
    <>
      <div className="mt-5 mb-3 space-y-4 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div className="w-3/4 mx-auto">
        ...
        placeholder="Enter header"
          type="text"
          required
          className="block  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-lg outline-none border-none"
          value={header}

...
const Home = () => {
  return (
    <div>
      <Link to={'/admin-login'} className='border-2 p-2 bg-blue-400'>Admin Login</Link>
      <Link to={'/coordinator-login'} className='border-2 p-2 bg-blue-400'>Coordinator Login</Link>
      ...
      <Link to={'/login-student'} className='border-2 p-2 bg-blue-400'>Student Login</Link>
